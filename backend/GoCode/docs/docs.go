...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.CreateAppRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.UpdateAppRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.MoveAppRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "Application or target VM not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.CreateGroupRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.UpdateGroupRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.ModifyGroupUsersRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.LoginRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api_functions.LoginResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid input",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.CreateUserRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/tables.OperatingSystem"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.CreateOSRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "OS version already exists",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/os/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated OS details",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.UpdateOSRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.CreateVMRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.UpdateVMRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/vms/{id}/applications": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Applications to add or remove",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api_functions.ManageVMApplicationsRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "api_functions.CreateAppRequest": {
            "type": "object",
            "required": [
                "application_name",
                "application_type"
        ...
        "api_functions.CreateGroupRequest": {
            "type": "object",
            "required": [
                "group_name",
                "role"
        ...
        "api_functions.CreateUserRequest": {
            "type": "object",
            "required": [
                "email",
                "password",
        ...
        "api_functions.ManageVMApplicationsRequest": {
            "type": "object"
        },
        "api_functions.ModifyGroupUsersRequest": {
            "type": "object",
            "required": [
                "user_ids"
            ],
        ...
        "api_functions.UpdateAppRequest": {
            "type": "object",
            "properties": {
                "application_name": {
                    "type": "string"
        ...
        "api_functions.UpdateGroupRequest": {
            "type": "object",
            "properties": {
                "group_name": {
                    "type": "string"
        ...
        "tables.VM": {
            ...
            "properties": {
                "applications": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/tables.Application"
                    }
                },
                "createdAt": {
                    "type": "string"
